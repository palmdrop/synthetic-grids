<script lang="ts">
  ...
  import { getFragmentsSpace, spaceMetadata } from "./graphics/three/synthetics/spaces/fragments/fragmentsSpace";
  ...
  onMount(() => {
    scene = new SyntheticGrids(canvas, getFragmentsSpace, spaceMetadata, undefined, interactive);
    scene.resize();
    scene.start();
