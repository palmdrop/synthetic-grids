<script lang="ts">
  ...
  import { getCliffscapeSpace, spaceMetadata } from "./graphics/three/synthetics/spaces/cliffscape/cliffscapeSpace";
  ...
  onMount(() => {
    scene = new SyntheticGrids(canvas, getCliffscapeSpace, spaceMetadata, undefined, interactive);
    scene.resize();
    scene.start();
